...
PHANTOMJSCLOUD_WEBSITES = ['https://twitter.com/', 'https://t.co/', 'https://medium.com/', 'https://app.mailbrew.com/', 'https://us12.campaign-archive.com',
                           ...
                           'https://www.v2ex.com', 'https://www.producthunt.com', 'http://xueqiu.com', 'https://www.jisilu.cn', 'https://www.163.com',
                           'https://time.com/*']
...
def scrape_website(url: str) -> str:
    endpoint_url = f"https://hcbscraper.boboom.workers.dev/?url={url}&selector=p"
    # headers = {
    ...
    if response.status_code == 200:
        try:
            ...
            tag_array = json_response['result']['p']
            text = ''.join(tag_array)
